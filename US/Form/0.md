...
0.sec={Intro.sec}
CodersNote=Modularize Section 1. First we make it look to a semantic name, and then reference the module.

1.sec={Def.Confidential_Information.sec}

Def.Confidential_Information.=[G/CooleyGo/NDA/US/Sec/Def/Confidential_Information/0.md]
...
4.sec={Conf.Except.Mandatory.sec}
